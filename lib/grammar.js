 ...
 * @generatedfrom ./grammar.macro.js#bd9690d00576d3b759db30225cebe38f04bbf3ad
...
let _initProto,
  _MatcherDecs,
  _GapNodeMatcherDecs,
  _ArrayNodeMatcherDecs,
  _NullNodeMatcherDecs,
  _PropertyMatcherDecs,
  _BasicNodeMatcherDecs,
  _CloseNodeMatcherDecs,
  _StringMatcherDecs,
  _StringDecs,
  _RegexDecs,
  _ListDecs,
...
export const grammar = class SpamexGrammar {
  static {
    [_initProto] = _applyDecs(
      this,
      [
        [_MatcherDecs, 2, 'Matcher'],
        [_GapNodeMatcherDecs, 2, 'GapNodeMatcher'],
        [_ArrayNodeMatcherDecs, 2, 'ArrayNodeMatcher'],
        [_NullNodeMatcherDecs, 2, 'NullNodeMatcher'],
        [_PropertyMatcherDecs, 2, 'PropertyMatcher'],
        [Node, 2, 'ReferenceMatcher'],
        [_BasicNodeMatcherDecs, 2, 'BasicNodeMatcher'],
        [Node, 2, 'OpenNodeMatcher'],
        [_CloseNodeMatcherDecs, 2, 'CloseNodeMatcher'],
        [_StringMatcherDecs, 2, 'StringMatcher'],
  ...
  *[((_MatcherDecs = CoveredBy('Expression')),
  (_GapNodeMatcherDecs = [Node, CoveredBy('NodeMatcher')]),
  (_ArrayNodeMatcherDecs = [Node, CoveredBy('NodeMatcher')]),
  (_NullNodeMatcherDecs = [Node, CoveredBy('NodeMatcher')]),
  (_PropertyMatcherDecs = [Node, CoveredBy('Matcher')]),
  (_BasicNodeMatcherDecs = [Node, CoveredBy('NodeMatcher')]),
  (_CloseNodeMatcherDecs = [Node, CoveredBy('Matcher')]),
  (_StringMatcherDecs = [CoveredBy('Matcher'), CoveredBy('Expression')]),
  (_StringDecs = [CoveredBy('StringMatcher'), CoveredBy('Matcher'), CoveredBy('Expression'), Node]),
  (_RegexDecs = [CoveredBy('StringMatcher'), CoveredBy('Matcher'), CoveredBy('Expression'), Node]),
  (_ListDecs = InjectFrom(productions)),
